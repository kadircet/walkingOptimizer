...
void startDY()
{
        ...
        dy_data_set_float(tripodtime=dy_data_create(DY_FLOAT, "robot.walking.params.tripodTime"), 
WALK_TRIPODTIME_DFLT);
        dy_data_set_float(standadjtime=dy_data_create(DY_FLOAT, "robot.walking.params.standAdjTime"), 
WALK_ADJTIME_DFLT);
        dy_data_set_float(cpgperiod=dy_data_create(DY_FLOAT, "robot.walking.params.cpgPeriod"), 
WALK_CPGPERIOD_DFLT);
        dy_data_set_float(smooth=dy_data_create(DY_FLOAT, "robot.walking.params.smooth"), 
WALK_SMOOTH_DFLT);
        ...
        dy_data_create(DY_FLOAT, "MEMORYLEAKOFDYN");
